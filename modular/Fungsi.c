...
void pengembalian(){
       ...
       printf("\n\n Review Data Diri : \n\n");
       printf("Nama            : %s\n",arrpenyewaan[hapus-1].nama);
       printf("No. KTP/SIM     : %s\n",arrpenyewaan[hapus-1].ID);
       printf("Alamat          : %s\n",arrpenyewaan[hapus-1].alamat);
       printf("Motor           : %s\n",arrpenyewaan[hapus-1].motor.nama);
       printf("Tanggal Sewa    : %d-%d-%d \n", arrpenyewaan[hapus-1].tgl_sewa.dd, arrpenyewaan[hapus-1].tgl_sewa.mm, arrpenyewaan[hapus-1].tgl_sewa.yyyy);
       printf("Tanggal Kembali : %d-%d-%d \n", arrpenyewaan[hapus-1].tgl_kembali.dd, arrpenyewaan[hapus-1].tgl_kembali.mm, arrpenyewaan[hapus-1].tgl_kembali.yyyy);
       printf("Lama Sewa       : %d hari\n",arrpenyewaan[hapus-1].lama_sewa);
       printf("Biaya           : Rp %d \n",arrpenyewaan[hapus-1].biaya);
       getchar();
